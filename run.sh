...
video_folder=/NASdata/lyx/RealEstate10K/video_highquality_test
pose_folder=/share/wjh/RealEstate10K/test
caption_path=${tag}_captions.json
...
python generate_realestate_csv.py --clips_folder ${clips_folder} \
    --caption_path ${caption_path} --pose_folder ${pose_folder} --pose_npy_folder ${pose_npy_folder} \
